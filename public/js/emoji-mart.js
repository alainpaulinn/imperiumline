! function() {
	...
	function $(e) {
		(!e.__d && (e.__d = !0) && B.push(e) && !Y.__r++ || A !== R.debounceRendering) && ((A = R.debounceRendering) || T)(Y)
	}

	function Y() {
		for (var e; Y.__r = B.length;) e = B.sort((function(e, t) {
	...
	function J(e, t, r, n, o, i, a, s, c, l) {
		...
		for (r.__k = [], u = 0; u < t.length; u++)
			if (null != (p = r.__k[u] = null == (p = t[u]) || "boolean" == typeof p ? null : "string" == typeof p || "number" == typeof p || "bigint" == (void 0 === p ? "undefined" : j(p)) ? N(null, p, null, null, p) : Array.isArray(p) ? N(q, {
				...
				oe(e, p, h = h || H, o, i, a, s, c, l), f = p.__e, (d = p.ref) && h.ref != d && (g || (g = []), h.ref && g.push(h.ref, null, p), g.push(d, p.__c || f, p)), null != f ? (null == v && (v = f), "function" == typeof p.type && p.__k === h.__k ? p.__d = c = X(p, c, e) : c = Q(e, p, h, m, f, c), "function" == typeof r.type && (r.__d = c)) : c && h.__e == c && c.parentNode != e && (c = G(h))
	...
	function X(e, t, r) {
		for (var n, o = e.__k, i = 0; o && i < o.length; i++)(n = o[i]) && (n.__ = e, t = "function" == typeof n.type ? X(n, t, r) : Q(r, n, n, o, n.__e, t));
		return t
	}
	...
	function oe(e, t, r, n, o, i, a, s, c) {
		...
		try {
			e: if ("function" == typeof y) {
				...
				u.context = _, u.props = g, u.state = u.__s, (l = R.__r) && l(t), u.__d = !1, u.__v = t, u.__P = e, l = u.render(u.props, u.state, u.context), u.state = u.__s, null != u.getChildContext && (n = F(F({}, n), u.getChildContext())), d || null == u.getSnapshotBeforeUpdate || (f = u.getSnapshotBeforeUpdate(h, p)), b = null != l && l.type === q && null == l.key ? l.props.children : l, J(e, Array.isArray(b) ? b : [b], t, r, n, o, i, a, s, c), u.base = t.__e, t.__h = null, u.__h.length && a.push(u), v && (u.__E = u.__ = null), u.__e = !1
				...
				if (null === p) d === h || s && e.data === h || (e.data = h);
					...
					else if (f = t.props.children, J(e, Array.isArray(f) ? f : [f], t, r, n, o && "foreignObject" !== p, i, a, i ? i[0] : r.__k && G(r, 0), s), null != i)
	...
	}, W.prototype.render = q, B = [], T = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Y.__r = 0;
	var ue = 0;
	...
	function Oe() {
		return (Oe = i(t(z).mark((function e(r) {
			var n, o, i, a, s, c, l, u, d, h, p, f, v, g, m, _, y, k, w, x, C, S, j, L, M, E, P, R, O, B, T, A, H, I, D, F, V, U, N, q, W, G, K;
			return t(z).wrap((function(e) {
				for (;;) switch (e.prev = e.next) {
					case 0:
					...
					case 116:
						...
						if (w = !0, P.search = "," + [
								...
								return e && e.trim()
							})).join(","), O = !0, B = !1, T = void 0, !P.emoticons) {
							e.next = 145;
							break
						}
						e.prev = 121, A = P.emoticons[Symbol.iterator]();
					case 123:
						if (O = (H = A.next()).done) {
							e.next = 131;
							break
					...
					case 131:
						...
						break;
					case 133:
						e.prev = 133, e.t10 = e.catch(121), B = !0, T = e.t10;
					case 137:
						e.prev = 137, e.prev = 138, O || null == A.return || A.return();
					case 140:
						if (e.prev = 140, !B) {
							e.next = 143;
							break
		...
		return He = i(t(z).mark((function e(r) {
			...
			return t(z).wrap((function(e) {
				for (;;) switch (e.prev = e.next) {
					...
					case 9:
						s = Ae || (Ae = Object.values(Ce.emojis)), u = !0, d = !1, h = void 0, e.prev = 12, p = a[Symbol.iterator]();
					case 14:
						if (u = (f = p.next()).done) {
							e.next = 54;
							break
	...
	function Ge(e) {
		...
		var i = n.skins[r - 1] || n.skins[0],
			a = i.src || ("native" == e.set || e.spritesheet ? void 0 : "function" == typeof e.getImageURL ? e.getImageURL(e.set, i.unified) : "https://cdn.jsdelivr.net/npm/emoji-datasource-".concat(e.set, "@14.0.0/img/").concat(e.set, "/64/").concat(i.unified, ".png")),
			s = "function" == typeof e.getSpritesheetURL ? e.getSpritesheetURL(e.set) : "https://cdn.jsdelivr.net/npm/emoji-datasource-".concat(e.set, "@14.0.0/img/").concat(e.set, "/sheets-256/64.png");
		return de("span", {
	...
	function Je(e) {
		...
		return Je = function(e) {
			...
			function n() {
				return Ye(e, arguments, S(this).constructor)
			}
	...
	var Ze = function(e) {
			...
			return c(r, [{
				...
				value: function(e, t, r) {
					if (this.component) {
						var n = Te(e, l({}, e, r), this.constructor.Props, this);
	...
	var Bt = {
		...
		It = function(e) {
			...
			function o(e) {
				var s;
				a(this, o), l(n(s = r.call(this)), "handleClickOutside", (function(e) {
					var t = s.props.element;
					e.target != t && (s.state.showSkins && s.closeSkins(), s.props.onClickOutside && s.props.onClickOutside())
							...
							children: [de("div", {
								...
								children: de("div", e ? {
									...
									children: [de("div", {
										...
										children: xe.search_no_results_1
									}), de("div", {
										class: "ellipsis color-c",
										style: {
											fontSize: ".9em"
										},
										children: xe.search_no_results_2
									})]
								} : {
									class: "color-c",
									style: {
				...
				value: function() {
					...
					return de("div", {
						children: [de("div", {
							...
							class: "flex flex-middle",
							children: [e && "rtl" == this.dir && this.renderSkinToneButton(), de("div", {
